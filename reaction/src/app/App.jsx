...
function App() {
  ...
  return (
    <div className="App">
      <Game setReactionTime={setReactionTime} average = {average} reactionArr={reactionArr} reactionScore={reactionScore} setAverage={setAverage} setReactionScore={setReactionScore}></Game>
    </div>
  );
}
